...
Я - Backend-разработчик, фокусируюсь на **Go** и создании надёжных сервисов.  
Также имею опыт коммерческой разработки на **TypeScript** (NestJS, React), сейчас углубляюсь в высоконагруженные системы, чистую архитектуру и наблюдаемость.
